...
#  -DNO_HOSTGROUPS to compile out hostgrouping code
...
SRCS = util.c event.c io.c chunk.c atom.c object.c log.c diskcache.c main.c \
       ...
       http_parse.c parse_time.c dns.c forbidden.c hostgroups.c \
...
OBJS = util.o event.o io.o chunk.o atom.o object.o log.o diskcache.o main.o \
       ...
       http_parse.o parse_time.o dns.o forbidden.o hostgroups.o \
